/*
     Scrip utilizado para eliminar extensiones
*/

// Arreglo con todas las extensiones que se desean eliminar.
var Extensions = [
...
// Funcion encargada de eliminar las extensiones
function Process()
{
          ...
          var Interval = setInterval(function(){
               if(NewWindow.document.getElementById('ui-id-' + IdExtension) != null){
                    ...
                    var deleteInterval = setInterval(function(){
                         ...
                         if(NewWindow.document.getElementById('del') != null){

                              clearInterval(deleteInterval);

                              NewWindow.document.getElementById('del').click();
